        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-gray-50 rounded-lg p-4 shadow-md border border-gray-200">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="text-sm font-semibold text-gray-900">Urban Population</div>
            </div>
            <div className="text-3xl font-bold text-blue-600">{(totalUrban / 1_000_000).toFixed(1)}M</div>
            <div className="text-sm text-gray-700 mt-1">{urbanPercent}% of total</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-4 shadow-md border border-gray-200">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-4 h-4 bg-green-600 rounded"></div>
              <div className="text-sm font-semibold text-gray-900">Rural Population</div>
            </div>
            <div className="text-3xl font-bold text-green-600">{(totalRural / 1_000_000).toFixed(1)}M</div>
            <div className="text-sm text-gray-700 mt-1">{ruralPercent}% of total</div>
          </div>
        </div>
      </div>
