  ...
  return (
    <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8 border-2 border-gray-200">
      <div className="mb-3 sm:mb-4">
        <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-2">3D Housing Infrastructure</h3>
        <p className="text-gray-700 text-sm sm:text-base">Interactive 3D surface chart showing housing types distribution. Use mouse to rotate, zoom, and pan.</p>
      </div>
